...
<body>
    ...
    <div>
        ...
        <input id="BtnAdd" type="button" style="width:100px" value="Add" onclick="return BtnAdd_onclick()" /></td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                <td style="text-align:right" class="style2">
                    <asp:TextBox 
            ID="TextBox1" runat="server" Width="402px"></asp:TextBox>
                </td>
            ...
            <tr>
                <td style="text-align:center" class="style2" colspan="2">
                    <asp:Label ID="lblSearchResult" runat="server" Font-Bold="True" 
                        Font-Size="XX-Large" Text="Search Result :" Visible="False"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="text-align:center" class="style2" colspan="2">
