/// <reference path="../../UI/Receiption/frmRegistration.aspx" />
/// <reference path="../../UI/Receiption/frmRegistration.aspx" />
...
function BtnAdd_onclick() {
    ...
    OpenWindow("../../UI/Receiption/frmRegistration.aspx", "Registration", true, "Registration");
...
function NewWindow()
{
    window.location = '/UI/Receiption/frmRegistration.aspx';
}
