<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmReportDoctorVisit.aspx.cs" Inherits="OnlineOutPatientManagementSystem.Report.ReportMenue.frmReportDoctorVisit" %>
...
<head runat="server">
    ...
    <script type="text/javascript"  lang="javascript">
        ...
        function openReport() {
            ...
            var strStartDate = document.getElementById('dtStartDate').value;
            var strEndDate = document.getElementById('dtEndDate').value;


            var url = "../frmCommonReportViewer.aspx?prmReportNmae=DailyDoctorVisit &prmStartDate=" + strStartDate + " &prmEndDate=" + strEndDate + " ";
...
<body>
    <form id="ReportDoctorVisit" runat="server">
                ...
                <table class="style100">
                    <tr>
                        ...
                        <td class="style70">
                            ...
                            <telerik:RadDatePicker ID="dtStartDate" Runat="server" Culture="English (United States)">
