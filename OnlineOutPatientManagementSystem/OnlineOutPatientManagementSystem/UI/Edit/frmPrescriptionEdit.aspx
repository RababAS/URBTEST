...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPrescriptionEdit.aspx.cs" EnableEventValidation="false"
Inherits="OnlineOutPatientManagementSystem.UI.Edit.frmPrescriptionEdit"%>
...
<script src="../../Scripts/jquery-1.4.1-vsdoc.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        $(function () {
            $("#PrescriptionEdit").validationEngine('attach', { promptPosition: "topRight" });
        });
    </script>
	...
	<script type="text/javascript"  language="javascript">
	    ...
	    function confirmCancel() {
	        ...
	        if (!confirm(mgs)) { return false }
	            ...
	            window.location = '/UI/Edit/frmPrescriptionFrontEdit.aspx';
	            return false
...
<body>
	<form id="PrescriptionEdit" runat="server" DefaultButton="">
		...
		<div style="display: inline-block;  width:98%;">
            ...
            <div class="style1" style="font-size:xx-large; font-style:normal;font-weight:bold; color: #FFFFFF;">
			 Prescription
            </div>
					...
					<legend id="PBasicInfo">Patient's Basic Information</legend>
                     <table style="width: 100%; height: 100%">
                         ...
                         <tr>
                             ...
                             <td style="width: 30%">
                                 <asp:TextBox ID="txtVisitID" runat="server" Width="100" Enabled="false"> </asp:TextBox>
                             </td>
                             ...
                             <td style="width: 30%">
                                 <asp:TextBox ID="txtPID" runat="server" Width="100" Enabled="false"> </asp:TextBox>
                             </td>
                         </tr>
                     </table>
                     ...
                     <table style="width: 100%; height: 100%">
                         <tr>
                             ...
                             <td style="width: 80%">
                                 <asp:TextBox ID="txtName" runat="server" Width="310" Enabled="false"> </asp:TextBox>
                             </td>
                         </tr>
                     </table>
                      ...
                      <table style="width: 100%; height: 100%">
                         <tr>
                             ...
                             <td style="width: 30%">
                                 <asp:TextBox ID="txtSex" runat="server" Width="50" Enabled="false"> </asp:TextBox>
                             </td>
                             ...
                             <td style="width: 30%">                       
                                 <asp:DropDownList ID="ddlDrugAllergy" runat="server" Width="100px" CssClass="validate[required]">
                                 </asp:DropDownList>

                                 <cc1:CascadingDropDown ID="ccddlDrugAllergy" TargetControlID="ddlDrugAllergy" PromptText="Select Drug Allergy"
                                     PromptValue="" ServicePath="../../WebService/LookUp.asmx" ServiceMethod="GetDrugAllergyList" runat="server"
                                     Category="MNCode" LoadingText="Loading..." />
                     ...
                     <table style="width: 100%; height: 100%">
                         <tr>
                             ...
                             <td style="width: 78%">
                                 <asp:TextBox ID="txtDrufHis" runat="server" Width="310" 
                                     onkeydown = "return (event.keyCode!=13);" 
                                     MaxLength="50"  EmptyMessage="Type Drug History"> </asp:TextBox>
                             </td>
                         </tr>
                    ...
                    <fieldset>
                        ...
                        <div>
                            <table style="width: 100%; height: 100%">
                                ...
                                <tr>
                                    <td> 
                                        <div>
                                            ...
                                            DataSourceID="SqlDSAdvice" AllowPaging="True" OnItemInserted="RGAdvice_ItemInserted" PageSize="5" Width="350px" Font-Names="SutonnyMJ">
                                ...
                                <tr>
                                    <td>
                                        <asp:DropDownList ID="ddlReferred" runat="server" Width="150px" CssClass="validate[required]">
                                        </asp:DropDownList>

                                        <cc1:CascadingDropDown ID="ccddlReferred" TargetControlID="ddlReferred" PromptText="Select Referred"
                                            PromptValue="" ServicePath="../../WebService/LookUp.asmx" ServiceMethod="GetReferredList" runat="server"
                                            Category="RefCode" LoadingText="Loading..." />
                        ...
                        <table style="width: 100%; height: 100%">
                            <tr>
                                ...
                                <td style="width: 20%; height: 100%">
                                    ...
                                    <asp:Button class="clsSave" ID="btnUpdate" runat="server" Text="Update" OnClick="btnUpdate_Click">                                       
                                  </asp:Button>
                                </td>
                                <td style="width: 20%; height: 100%">
		...
		<div>
			 ...
			 <tr>
				 <td>
                     <cc1:ToolkitScriptManager ID="ToolkitSM_Prescriptions" runat="server">
